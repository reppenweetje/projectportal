...
export const deHofman: Project = {
  ...
  heroImage: {
    ...
    alt: "De Hofman bij avond, exterieur",
    caption: "Impressie · De Hofman bij avond",
  },
  gallery: [
    {
      src: `${baseRender}/2-eve.jpg`,
      alt: "De Hofman bij avond, hoofdaanzicht",
      caption: "Hoofdaanzicht bij avond",
      weight: 100,
    },
    {
      src: `${baseRender}/2-day.jpg`,
      alt: "De Hofman bij daglicht, hoofdaanzicht",
      caption: "Hoofdaanzicht overdag",
      weight: 90,
    },
    {
    ...
    {
      src: `${baseRender}/3-day.jpg`,
      alt: "Zijgevel met units overdag",
      caption: "Zijgevel overdag",
      weight: 70,
    },
    {
      src: `${baseRender}/4-eve.jpg`,
      alt: "Detail entree bij avond",
      caption: "Entree bij avond",
      weight: 60,
    },
    {
      src: `${baseRender}/4-day.jpg`,
      alt: "Detail entree overdag",
      caption: "Entree overdag",
      weight: 50,
    },
    {
      src: `${baseRender}/5-eve.jpg`,
      alt: "Showroom-impressie bij avond",
      caption: "Showrooms bij avond",
      weight: 40,
    },
    {
      src: `${baseRender}/5-day.jpg`,
      alt: "Showroom-impressie overdag",
      caption: "Showrooms overdag",
      weight: 30,
    },
  ],
