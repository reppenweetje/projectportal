...
/** "Waarom is deze unit er nog?": het eerlijke antwoord, met de sparren-CTA. */
    ...
    <section className="px-5 py-16 md:py-20 bg-white">
      <div className="mx-auto max-w-3xl text-center">
        ...
        <p className="mt-4 text-repp-navy/70 leading-relaxed">
          ...
          ondernemers past. De andere XXL is verkocht onder voorbehoud
          van financiering. Deze XXL-unit is dus geen restant. Het is de unit waar de
